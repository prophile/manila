...
class manila_driver_fs_compress_zlib extends manila_driver implements manila_interface_filesystem
{
	private $child = NULL;
	private $level;
	...
	{
		return $this->child->file_exists("$path.gz");
	}
	...
	{
		$list = $this->child->file_directory_list($dir);
