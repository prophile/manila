...
class webdav_client {
	...
	private $_errno;
	private $_errstr;
	private $_user_agent = 'php class webdav_client $Revision: 1.7 $';
	private $_crlf = "\r\n";
	private $_req;
...
/** 
 ...
 /** 
	...
	* Stores data found into class private _ls_ref_cdata
 ...
 /** 
	...
	* Is used by public method delete.
	* Will be called by php xml_set_character_data_handler() when xml data has to be handled.
	* Stores data found into class private _delete_ref_cdata
	* @param resource parser, string cdata
	* @access private
	*/ 
...
/**
 ...
 /** 
	...
	* Will be called by php xml_set_character_data_handler() when xml data has to be handled.
	* Stores data found into class private _lock_ref_cdata
	* @param resource parser, string cdata
	* @access private
	*/ 
 ...
 /**
	...
	* 
	* extends class private array _req  
	* @param string string
	* @access private
	*/
 ...
 /**
	...
	* 
	* unsets class private array _req  
	* @access private
	*/
